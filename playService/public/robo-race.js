...
},{"../common/constants":14,"../common/images":16,"./gameBoard/scenario":28,"lodash":2,"snabbdom/h":3}],25:[function(require,module,exports){
const headers = require('../common/service-headers')
...
const defs = [
  ...
  `<g id="robot-starting-point" transform="scale(0.6) translate(-0.5 -0.5) scale(${1.0/32}) translate(2 6)">
...
function svg(scenario, excludeInitialRobots) {
  ...
  const robots = scenario.initialRobots.map((robot, index) =>
...
},{"lodash":2,"snabbdom/h":3}],29:[function(require,module,exports){
...
},{"../common/button":13,"../common/frame":15,"../common/modal":17,"../game/gameBoard/scenario":28,"snabbdom/h":3}],33:[function(require,module,exports){
const snabbdom = require('snabbdom')
const patch = snabbdom.init([
  require('snabbdom/modules/eventlisteners').default,
  require('snabbdom/modules/props').default,
